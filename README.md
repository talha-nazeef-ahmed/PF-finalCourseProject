...
- Search, sort, and filter logs by various fields
- Export and import logs
- Statistics dashboard and trend analysis
- Anomaly detection (brute-force detection and suspicious activity detection)
- System diagnostics and session summaries
